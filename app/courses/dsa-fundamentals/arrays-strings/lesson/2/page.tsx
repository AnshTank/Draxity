...
const lessonData = {
  ...
  overview: "Master the fundamental operations you can perform on arrays: insertion, deletion, searching, and updating elements.",
  theory: {
    sections: [
      {
        heading: "Array Operations Overview",
        content: "Arrays support several key operations that allow you to manipulate and work with the stored data. Understanding these operations and their complexities is crucial for efficient programming."
      },
      {
        heading: "Insertion Operations",
        content: "You can insert elements at the beginning, middle, or end of an array. Insertion at the end is fastest (O(1) if space is available), while insertion at the beginning or middle requires shifting elements (O(n))."
      },
      {
        heading: "Deletion Operations",
        content: "Similar to insertion, deletion can happen at any position. Deleting from the end is fastest, while deleting from the beginning or middle requires shifting remaining elements to fill the gap."
      },
      {
        heading: "Search Operations",
        content: "Arrays support both linear search (checking each element) and binary search (for sorted arrays). Linear search is O(n) while binary search is O(log n)."
      }
    ]
  },
  diagram: {
...
public class ArrayOperations {
  ...
  analogy: {
    ...
    content: "Think of array operations like managing a queue of people. Adding someone to the end is quick, but inserting someone in the middle means everyone behind them has to move back one position. Similarly, removing someone from the middle means everyone behind moves forward to fill the gap."
  },
  nextLesson: "3"
}
