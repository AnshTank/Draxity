...
print(f"Total students: {len(marks)}")`,
  ...
  references: {
    articles: [
      { title: "Arrays in Data Structures - GeeksforGeeks", url: "https://www.geeksforgeeks.org/array-data-structure/" },
      { title: "Introduction to Arrays - Programiz", url: "https://www.programiz.com/dsa/array" },
      { title: "Array Data Structure - Tutorialspoint", url: "https://www.tutorialspoint.com/data_structures_algorithms/array_data_structure.htm" }
    ],
    videos: [
      { title: "Arrays Explained - CS Dojo", url: "https://www.youtube.com/watch?v=QJNwK2uJyGs" },
      { title: "Data Structures: Arrays - HackerRank", url: "https://www.youtube.com/watch?v=rL8X2mlNHPM" },
      { title: "Array Data Structure - mycodeschool", url: "https://www.youtube.com/watch?v=55l-aZ7_F24" }
    ]
  }
}
