        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-10">
            {sampleQuestions.map((question, index) => {
              ...
              return (
                <div key={index} className="relative bg-white dark:bg-gray-900 rounded-3xl border border-gray-200 dark:border-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
                      ...
                      <div className="flex-1 space-y-6">
                        ...
                        <div className="space-y-4">
                          {question.options.map((option, optIndex) => {
                            ...
                            return (
                              <div key={optIndex} className={`p-4 rounded-2xl border-2 transition-all ${
                                isCorrectAnswer 
                                ...
                                <div className="flex items-center gap-3">
                                  {isCorrectAnswer && <CheckCircle className="h-5 w-5 text-green-600 flex-shrink-0" />}
                                  {isUserAnswer && !isCorrectAnswer && <XCircle className="h-5 w-5 text-red-600 flex-shrink-0" />}
                                  <span className={`text-base flex-1 ${
                                    isCorrectAnswer ? 'text-green-800 dark:text-green-200 font-medium' :
                                    isUserAnswer ? 'text-red-800 dark:text-red-200 font-medium' :
                                    'text-foreground'
                                  }`}>{option}</span>
                                  {isCorrectAnswer && (
