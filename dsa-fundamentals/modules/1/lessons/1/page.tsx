    ...
    sections: [
      {
        ...
        content:
          "Imagine you need to keep track of the marks of 5 students. Instead of creating 5 separate variables (mark1, mark2, ...), arrays allow you to store them in a single structure where each mark can be accessed by its index.",
      },
      {
        heading: "Key Characteristics",
        content:
          "Arrays store elements of the same data type in consecutive memory locations. Each element has a unique index starting from 0, making it easy to access any element directly.",
      },
      {
        heading: "Memory Layout",
        content:
          "Arrays are stored in contiguous memory locations, which means elements are placed one after another. This allows for efficient memory usage and fast access times.",
      },
    ],
  },
  diagram: {
